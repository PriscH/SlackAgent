 ...
 *         &lt;element name="parentItem" type="{urn:sbmappservices72}ItemIdentifier"/>
 *         &lt;element name="childItem" type="{urn:sbmappservices72}ItemIdentifier"/>
...
@XmlRootElement(name = "LinkSubtask")
public class LinkSubtask {
    ...
    protected ItemIdentifier parentItem;
    @XmlElement(required = true, nillable = true)
    protected ItemIdentifier childItem;
     ...
     *     
     */
    public ItemIdentifier getParentItem() {
        return parentItem;
    }
     ...
     *     
     */
    public void setParentItem(ItemIdentifier value) {
     ...
     *     
     */
    public ItemIdentifier getChildItem() {
        return childItem;
    }
     ...
     *     
     */
    public void setChildItem(ItemIdentifier value) {
