...
public class Auth {
    ...
    @XmlElementRef(name = "userId", namespace = "urn:sbmappservices72", type = JAXBElement.class, required = false)
    protected JAXBElement<String> userId;
    @XmlElementRef(name = "password", namespace = "urn:sbmappservices72", type = JAXBElement.class, required = false)
    protected JAXBElement<String> password;
    @XmlElementRef(name = "hostname", namespace = "urn:sbmappservices72", type = JAXBElement.class, required = false)
    protected JAXBElement<String> hostname;
    @XmlElementRef(name = "loginAsUserId", namespace = "urn:sbmappservices72", type = JAXBElement.class, required = false)
