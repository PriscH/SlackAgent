...
public class OrderBy {
    ...
    @XmlElementRef(name = "firstFieldName", namespace = "urn:sbmappservices72", type = JAXBElement.class, required = false)
    protected JAXBElement<String> firstFieldName;
    @XmlElementRef(name = "secondFieldName", namespace = "urn:sbmappservices72", type = JAXBElement.class, required = false)
