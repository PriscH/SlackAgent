 ...
 *         &lt;element name="report" type="{urn:sbmappservices72}ReportData" minOccurs="0"/>
...
@XmlRootElement(name = "RunReportXml")
public class RunReportXml {
    ...
    protected JAXBElement<ReportData> report;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ReportData }{@code >}
     *     
     */
    public JAXBElement<ReportData> getReport() {
        return report;
    }
     ...
     *     
     */
    public void setReport(JAXBElement<ReportData> value) {
        this.report = value;
    }
