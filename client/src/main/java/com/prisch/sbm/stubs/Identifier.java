...
@XmlSeeAlso({
    ReportIdentifier.class,
    SolutionIdentifier.class,
    ProjectIdentifier.class,
    TableIdentifier.class,
    UserIdentifier.class,
    ItemIdentifier.class,
    FieldIdentifier.class,
    TransitionIdentifier.class,
    ContactIdentifier.class,
    ApplicationIdentifier.class,
    GroupIdentifier.class,
    StateIdentifier.class,
    RoleIdentifier.class,
    WorkflowIdentifier.class
})
public class Identifier {

    @XmlElementRef(name = "displayName", namespace = "urn:sbmappservices72", type = JAXBElement.class, required = false)
